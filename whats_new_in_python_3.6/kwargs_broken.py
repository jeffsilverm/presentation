...
# 3to2 has trouble with this line:
#        print(f"Casting {arg_b} from {type(arg_b)} to str")
# 3to2 does not have trouble with this line:
        print("Casting {} from {} to str".format(arg_b, type(arg_b) ))
        arg_b = str(arg_b)
    if not isinstance(arg_c, int) and not isinstance(arg_c, bool) :
        # 3to2 has trouble with this line:
#        print(f"Casting {arg_c} from {type(arg_c)} to bool")
        # 3to2 does not have trouble with this line:
        print("Casting {} from {} to bool".format(arg_c,type(arg_c) ))
        arg_c = bool(arg_c)
